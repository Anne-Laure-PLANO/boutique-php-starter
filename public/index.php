...
$uri = $_SERVER['REQUEST_URI']; // contient l'URL demandé
    ...
    <div class="container">
        ...
        <section class="hero">
            <div class="container hero__content">
                ...
                <div class="hero__actions">
                    <a href="catalogue.php" class="btn btn--secondary btn--lg">Voir le catalogue</a>
        ...
        <section id="produits">
            <div class="section-header">
                ...
                <a href="catalogue.php" class="section-link">Voir tout →</a>
            </div>
