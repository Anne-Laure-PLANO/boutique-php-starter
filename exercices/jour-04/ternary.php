...
<body>
    <?php
        $catalogue = [
    [
        "dateSortie" => new DateTime('2026-01-04'),
        "name" => "Pantalon",
    ...
    [
        "dateSortie" => new DateTime('2023-01-04'),
        "name" => "Chemise",
    ...
    [
        "dateSortie" => new DateTime('2016-01-04'),
        "name" => "Chaussures",
    ...
    [
        "dateSortie" => new DateTime('2025-01-04'),
        "name" => "Echarpe",
    ...
    [
        "dateSortie" => new DateTime('2025-12-01'),
        "name" => "Collier",
    ...
    <?php foreach ($catalogue as $item) :?>
        <div style ="width : 15% ; min-width : 150px; border:1px solid black ; background-color: #e0d9d9ff ; margin : 10px ; padding : 20px ">
            <h2><?=$item["name"]?></h2>
            <p><?=$item["description"]?></p>
            <?=($item["stock"]>0)? "<p style = \"color:green\"> En stock </p>" : "<p style = \"color:red\"> En rupture </p>" ?>
            <p style = "<?=($item["promo"]>0)? "text-decoration:line-through " : "";?>" ><?=number_format($item["prix"], 2, ",", " ")?>€</p>
            <?php if ($item["promo"]>0 && $item["stock"]>0) : ?>
                <p style = "color : red">Promotion exceptionnelle : - <?=$item["promo"]?>% !</p>
                <p style= "color : green">Nouveau prix : <?=number_format(($item["prix"]*(1-$item["promo"]/100)), 2, "," , " ")?> €</p>
            <?php endif;?>
        </div>
    <?php endforeach ; ?>
    </div>
